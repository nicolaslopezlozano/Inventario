...
<!-- END THEME PANEL -->
    <h1 class="page-title"> Lista de Distribuidores
    </h1>
    <div class="page-bar">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Lista de Distribuidores</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ route('distribuidor.create') }}">
                                    <button id="sample_editable_1_new" class="btn sbold green"> Nuevo Distribuidor                                       
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-left" role="menu">
                                                                    <li>
                                                                        <a href="{{ route('distribuidor.show', ['id' => $user->id]) }}">
                                                                            <i class="icon-docs"></i> Editar </a>
                                                                    </li>
                                                                    <li>
                                                                        <form action="{{ route('distribuidor.destroy', ['id' => $user->id]) }}" method="POST">
                                                                            {{ csrf_field() }}
                                                                            {{ method_field('DELETE') }}
                                                                            &nbsp&nbsp
                                                                            <i class="icon-tag"></i>

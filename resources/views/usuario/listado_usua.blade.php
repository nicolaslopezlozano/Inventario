...
<!-- END THEME PANEL -->
    <h1 class="page-title"> Lista de Jefes de Proceso
    </h1>
    <div class="page-bar">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Lista de Jefes de Proceso</span>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    ...
                                    <button id="sample_editable_1_new" class="btn sbold green"> Nuevo Jefe de Proceso                                       

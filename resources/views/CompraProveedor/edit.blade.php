            ...
            <div class="portlet light portlet-fit portlet-form ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Editar Compra a Proveedor</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <!-- BEGIN FORM-->

                    <form method="POST" action="{{ url("compraproveedor/{$compra->id}") }}" id="form_sample_2" class="form-horizontal">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" class="form-control" name="number" value="{{ $compra->precio }}" placeholder="{{ $compra->precio }}"/> </div>
                                </div>
                            </div>
